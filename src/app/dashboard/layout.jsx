    ...
    return (
        <div className="h-screen w-full overflow-hidden bg-white">
            <div className="flex h-full w-full">
                {/* Sidebar */}
                <aside className="hidden md:flex h-screen w-[230px] shrink-0 flex-col bg-gray-900 text-white border-r border-white/[0.04] selection:bg-violet-500/30">
                    ...
                    <div className="relative px-5 py-4 shrink-0">
                        <div className="relative flex items-center gap-2.5">
                            ...
                            <div className="leading-none">
                                <div className="text-[13px] font-semibold tracking-[-0.02em] text-white/90">AgendaClinica</div>
                                <div className="mt-[3px] text-[10px] font-medium text-white/30">Panel Admin</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <nav className="flex-1 px-3 py-1 overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                        <div className="space-y-4">
                            ...
                            <details className="group" open>
                                <summary className="flex items-center justify-between px-2 py-1 text-[10px] font-extrabold text-white/25 hover:text-white/40 transition-colors duration-200 cursor-pointer list-none select-none">
                                    <span>Principal</span>
                                ...
                                <div className="mt-1 space-y-0.5">
                                    <Link
                                        href="/dashboard"
                                        className="group/link flex items-center gap-2.5 rounded-md px-2 py-[6px] text-[12.5px] font-normal text-white/50 hover:text-white/90 hover:bg-white/[0.05] transition-all duration-200"
                                    >
                        ...
                        <div className="mt-6 pt-4 relative">
                            ...
                            <div className="px-2 text-[10px] font-extrabold text-white/20">Atajos</div>
                    ...
                    <div className="relative px-3 py-3 shrink-0">
                        ...
                        <div className="rounded-lg bg-white/[0.03] ring-1 ring-white/[0.05] px-3 py-2.5">
                            <div className="flex items-center justify-between">
                                <div>
                                    <div className="text-[9px] font-semibold text-white/25 tracking-wide">Sistema</div>
                                    <div className="mt-0.5 text-[12px] font-medium text-white/60">Operativo</div>
                                </div>
